...
export const vertexModels = {
	...
	"moonshotai/kimi-k2-thinking-maas": {
		...
		inputPrice: 0.6,
		outputPrice: 2.5,
		description: "Moonshot AI Kimi K2 Thinking model (MaaS). Available in us-central1",
	},
	"minimaxai/minimax-m2-maas": {
		...
		inputPrice: 0.3,
		outputPrice: 1.2,
		description: "MiniMax M2 model (MaaS). Available in us-central1",
	},
	"qwen/qwen3-next-80b-a3b-thinking-maas": {
		...
		inputPrice: 0.5,
		outputPrice: 2.0,
		description: "Qwen3 Next 80B A3B Thinking model (MaaS). Available in us-south1",
	},
	"qwen/qwen3-next-80b-a3b-instruct-maas": {
		...
		inputPrice: 0.3,
		outputPrice: 1.2,
		description: "Qwen3 Next 80B A3B Instruct model (MaaS). Available in us-south1",
	},
	"deepseek-ai/deepseek-v3.2-maas": {
		...
		inputPrice: 0.6,
		outputPrice: 1.7,
		description: "DeepSeek V3.2 model (MaaS). Available in us-west2",
	},
	"mistralai/mistral-medium-3@001": {
		...
		inputPrice: 0.4,
		outputPrice: 2.0,
		description: "Mistral Medium 3 model. Available in us-central1",
	},
	"mistralai/codestral-2@001": {
		...
		inputPrice: 0.3,
		outputPrice: 0.9,
		description: "Codestral 2 model. Available in us-central1",
	},
	// kilocode_change end
