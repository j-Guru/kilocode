...
Summarization can use a cheaper or larger-context model than your main agent. In VS Code, choose **Compaction model** under **Settings → Models**, or configure a dedicated compaction agent in `kilo.jsonc`:
