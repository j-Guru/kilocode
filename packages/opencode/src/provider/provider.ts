      ...
      return {
        ...
        options: {
          ...
          fetch: async (input: RequestInfo | URL, init?: RequestInit) => {
            // kilocode_change: use explicit cloud-platform scope so Vertex MaaS
            // OpenAI-compatible endpoints receive a valid access token.
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(() =>
      Effect.gen(function* () {
        ...
        // kilocode_change start - alias enterprise Copilot to the Copilot provider data
