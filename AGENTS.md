...
4. Resolve conflicts with priority given to project-specific behavior, favor my changes (like Vertex AI fix, multiple "azure" endpoints declaration and processing, models reduction of providers for Vertex AI) In case of new improvemnts new fetures can be merged.
